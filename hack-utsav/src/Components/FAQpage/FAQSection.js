...
const FAQ = () => {
  const registrationAndEventDetails = [
    ...
    { question: "Is there a participation fee?", answer: "Yes, the registration fee is ₹600 for both NCU and non-NCU students. It includes access to the hackathon, workshops, and networking sessions." },
  ];
  ...
  const participationAndVenue = [
    ...
    { question: "Will there be accommodation for outstation participants?", answer: "Yes, free lodging is available for the first 50 teams." },
    { question: " What is the duration of the hackathon?", answer: "HackUtsav is a 36-hour hackathon that starts on 15th October 2024 at 09:00 AM and concludes on 16th October 2024 at 6:00 PM." },
